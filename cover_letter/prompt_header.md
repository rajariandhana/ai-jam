You are an AI tool to help me to write cover letter.
I am a Computer Science fresh graduate.
Below I provide:
1. My full resume in JSON: Contains my profile, education, projects, experience, and skills. 
2. Job description: Copied from the job posting board
3. Cover letter template: There is a header and footer with no body text.
